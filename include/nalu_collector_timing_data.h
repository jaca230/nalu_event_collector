 ...
 * @brief Holds timing data for a single collection cycle of the
 * NaluEventCollector.
 *
 * This struct stores various time metrics and performance data related to each
 * cycle of data collection, such as time spent on receiving UDP data, parsing
 * packets, processing events, and overall cycle performance. It is used to
 * monitor and optimize the data collection process.
 */
struct NaluCollectorTimingData {
    /**
    ...
    /**
     * @brief Time spent processing events after parsing the packets, in
     * seconds.
     * @size 8 bytes (double)
     */
    double event_time;
    ...
    /**
     * @brief Serializes the NaluCollectorTimingData to a buffer in one
     * operation.
     *
     * This method converts the struct into a byte array representation that can
     * be transmitted or stored. The buffer should be large enough to hold all
     * data in the struct.
     *
     ...
     *
     * This method can be used to determine how much space is required for
     * serialization.
     *
