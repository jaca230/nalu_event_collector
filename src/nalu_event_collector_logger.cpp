...
NaluEventCollectorLogger::LogLevel NaluEventCollectorLogger::log_level = NaluEventCollectorLogger::LogLevel::INFO;
...
void NaluEventCollectorLogger::set_level(LogLevel level) {
    log_level = level;
}

void NaluEventCollectorLogger::enable_file_logging(const std::string& filename) {
...
void NaluEventCollectorLogger::set_log_colors(const std::string& debug_color, const std::string& info_color,
...
void NaluEventCollectorLogger::log(const std::string& prefix, const std::string& message, LogLevel level) {
    if (level >= log_level) {
...
std::string NaluEventCollectorLogger::get_colored_message(const std::string& message, const std::string& color) {
